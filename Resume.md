...
- **乐投广告平台(2019.12~至今)**  
  ...
  * **成果收获：**
    ...
    2. 由于需要频繁跟数仓和运维跨部门协作 ，提升了跨部门沟通能力(积极沟通等方式) 项目上线和问题解决时间缩短。
    
    3. 可以帮助解决团队内很多业务和技术问题，系统保质保量完成。
